...
<p>
    With large images, the outline generated by magic SAM may not be very detailed. Sometimes smaller objects may not get an outline at all. In this case, point at the object to generate a rough outline or zoom to the small object and press <kbd>z</kbd>. This enables detailed mode. Magic SAM will now compute a detailed image embedding for this region of the image. Once the embedding is available, the outline will be updated.
</p>

<p>
    In detailed mode, magic SAM only works in part of the image. The rest of the image is dimmed to show you where magic SAM can be used. Press <kbd>z</kbd> again to disable detailed mode and get back to the default mode of magic SAM.
</p>
